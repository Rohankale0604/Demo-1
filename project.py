...
data = pd.read_csv(r"https://raw.githubusercontent.com/Rohankale0604/Demo-1/main/RELIANCE.NS%20Final.csv")
...
if navigation =="Historic data":
    ...
    image_path = (r"https://github.com/Rohankale0604/Demo-1/blob/main/stockpic.jpg")
